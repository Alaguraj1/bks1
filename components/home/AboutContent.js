        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            >
              <div className="about-content">
                ...
                <p style={{ fontSize: "16px" }}>
                  BKS Textiles is one of the leading textile solutions provider, with a vertically integrated production facility from yarn dyeing to finishing, producing a range of textile products from high-quality woven fabrics and stylish workwear to beautiful home textiles.
                </p>
                <p style={{ fontSize: "16px" }}>
            ...
            >
              ...
              <img src="/images/about/aboutUs.jpg" alt="image" style={{ width: "100%" }} />
              {/* </div> */}
            </div>
          </div>
        </div>
