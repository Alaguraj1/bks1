              ...
              <div className={classOne} id="navbarSupportedContent">
                <ul className="navbar-nav">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <Link
                          ...
                          className={`nav-link ${currentPath == "/apparel-fabrics/" && "active"
                            }`}
                        >
                          Apparel Fabrics
                        </Link>
                      ...
                      <li className="nav-item">
                        <Link
                          href="/workwear"
                          className={`nav-link ${currentPath == "/workwear/" && "active"
                            }`}
                        >
                          WorkWear
                        </Link>
                  ...
                  <li className="nav-item">
                    <Link
                      href="/certifications"
                      className={`nav-link ${currentPath == "/certifications/" && "active"
                        }`}
                    >
                      Certifications
                    </Link>
                  ...
                  <li className="nav-item">
                    <Link
                      href="/csr"
                      className={`nav-link ${currentPath == "/csr/" && "active"
                        }`}
                    >
                      CSR
                    </Link>
                  ...
                  <li className="nav-item">
                    <Link
                      href="/career"
                      className={`nav-link ${currentPath == "/career/" && "active"
                        }`}
                    >
                      Career
                    </Link>
